...
const NullTrips = () => {
    return (
        <div className="flex flex-col items-center justify-center">
            ...
            <button className="flex flex-row items-center bg-button-color px-6 py-2 mt-4 rounded-full text-white  text-xs hover:cursor-pointer hover:bg-button-color-hover">
